...
const steps = [
  { tag: "STEP 01", title: "ヒアリング ─ 現状の侵入口を整理", badge: "初回", badgeCls: "bg-emerald-100 text-emerald-700", desc: "公開資産やセキュリティ体制をヒアリングし、攻撃者から見える「侵入口候補」を整理して共有します。" },
  { tag: "STEP 02", title: "AI攻撃シミュレーション ─ 仮説と検証を自律で深掘り", badge: "主軸", badgeCls: "bg-violet-100 text-violet-700", desc: "AIが攻撃シナリオを生成し、前工程の結果を踏まえて次の検証を自律的に判断。「破られなかった」証拠を、経営向けレポートとしてお渡しします。" },
      ...
      <div className="max-w-7xl mx-auto px-6">
        <FadeIn className="max-w-xl mb-16">
          ...
          <h2 className="font-display font-bold text-[44px] tracking-tight text-brand-text mt-5 mb-5 leading-tight">
            段階導入で、<br />
            <span className="text-gradient">無理なく底上げする。</span>
          </h2>
